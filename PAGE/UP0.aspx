<%@ Page Title="UP0" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UP0.aspx.cs" Inherits="Praca_Inz_Michal_Dwojak.PAGE.UP0" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

       
    <h3> Uprawnienia poziom 0 </h3>
  ...
  <div class="panel-group">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand=" SELECT ISNULL( b.[RoleId], '0' ) as [ID Uprawnienia], ISNULL(Name, 'user' ) as [Uprawnienia],[UserName],[Number] FROM [AspNetUsers] as a Left join [AspNetUserRoles] as b ON a.[Id] = b.[UserId] Left join [AspNetRoles] as c ON b.[RoleId] = c.[Id] Where ISNULL( b.[RoleId], '0' ) ='0'">
           <%--   <SelectParameters>
