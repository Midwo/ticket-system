...
{
    public partial class Uprawnienia : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
...

            {
                if (Int32.Parse(mikd.Text) == 1)
                {
                    ...
                    { //Upadate
                        con.Open();
                        SqlCommand kol4 = new SqlCommand("UPDATE [AspNetUserRoles] SET [RoleId] ='" + RadioButtonList2.SelectedValue + "' where UserId ='" + mikd1.Text + "'", con);

                        kol4.ExecuteNonQuery();
                       
                        con.Close();
                        mikd.Text = "Uprawnienie nadane";
                    }
                    else
                    { //insert
                        con.Open();
                        SqlCommand kol5 = new SqlCommand("INSERT INTO [AspNetUserRoles] ([UserId],[RoleId]) VALUES ('" + mikd1.Text + "','" + RadioButtonList2.SelectedValue + "')", con);

                        kol5.ExecuteNonQuery();

                        con.Close();
                        mikd.Text = "Udprasdfsdfwnienisdfe nadane d";
                    }
