...
namespace Praca_Inz_Michal_Dwojak.PAGE
{
    public partial class Edit : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand drop1 = new SqlCommand("UPDATE [INZ_Ticket1] SET [DateMode] = '" + System.DateTime.Now.ToString("yyyy.MM.dd HH:mm:ss") + "', [ActiveStatus] ='4', [UserClose] = '1'  WHERE ID='" + selectID + "'", con);
            ...
            {
                con.Open();
                SqlCommand drop1 = new SqlCommand("UPDATE [INZ_Ticket1] SET [DateMode] = '" + System.DateTime.Now.ToString("yyyy.MM.dd HH:mm:ss") + "' WHERE ID='" + selectID + "'", con);
                drop1.ExecuteNonQuery();
                con.Close();
            }
            if (variabledrop1 == "3")
            {
                con.Open();
                SqlCommand drop1 = new SqlCommand("UPDATE [INZ_Ticket1] SET [DateMode] = '" + System.DateTime.Now.ToString("yyyy.MM.dd HH:mm:ss") + "', [BlockStatus] ='0', [BlockUser] = Null, [DateBlock] = Null, [ActiveStatus] ='2', [EndUser] = Null, [EndUserData] = Null, [UserClose] ='0' WHERE ID='" + selectID + "'", con);
                drop1.ExecuteNonQuery();
                con.Close();
            }
            ...
            Response.Redirect("~/Page/Ostatnie.aspx");
        }
