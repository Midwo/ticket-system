<%@ Page Title="Zgloszenia" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Zgloszenia.aspx.cs" Inherits="Praca_Inz_Michal_Dwojak.PAGE.Niezrealizowane_zgloszenia" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <li class="list-group-item">Block status: <asp:Label ID="Label3" runat="server" class="label label-default" Text="Label"></asp:Label> 
   ...
   <li class="list-group-item">Wiadomość:
    ...
    --%>
Wybierany status: <br /> <asp:DropDownList ID="DropDownList1" runat="server" class="btn btn-default dropdown-toggle"  OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
        <asp:ListItem   Value="-1">Wybierz</asp:ListItem>
        <asp:ListItem  Value="0">Zamknij powodzeniem</asp:ListItem>
        <asp:ListItem   Value="2">Otwarty status</asp:ListItem>
    <asp:ListItem   Value="3">Zablokuj</asp:ListItem>
    <asp:ListItem   Value="4">Anuluj</asp:ListItem>
    <asp:ListItem   Value="5">Zamknij niepowodzeniem</asp:ListItem>
    </asp:DropDownList>
<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Proszę wybrać status" ControlToValidate="DropDownList1"
        InitialValue="-1"
         style="color:Red;"></asp:RequiredFieldValidator>
               ...
               <br /> Wybierany piorytet: <br /> <asp:DropDownList ID="DropDownList2" runat="server" class="btn btn-default dropdown-toggle"  OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged">
...
<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Proszę wybrać status" ControlToValidate="DropDownList2"
        InitialValue="0"
         style="color:Red;"></asp:RequiredFieldValidator>
