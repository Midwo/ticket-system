...
{
    public partial class Moje : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (Calendar1.SelectedDate < Calendar2.SelectedDate.AddDays(1))
            {
                ...
                SqlDataSource1.SelectCommand = "SELECT [ID], [Range], SUBSTRING([Text],1,120) as Text, [DateMode] FROM [INZ_Ticket1] WHERE [UserCreate] = '" + Context.User.Identity.Name + "' and [DateMode] BETWEEN '" + dateStart + "' and '" + dateStop + "' ORDER BY [DateMode] DESC";
