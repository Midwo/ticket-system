<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Statystki_helpdesku.aspx.cs" Inherits="Praca_Inz_Michal_Dwojak.PAGE.Statystki_helpdesku" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">


    

    <h3> Wybierz zakres generowania danych - Data modyfikacji złoszenia</h3>
    <div class="row">
        <div class="col-md-4">
            <h3>Zakres od</h3>
  ...
  <div class="panel-group">
      ...
      <div class="panel-body">
          ...
          CssClass="table table-hover table-condensed" GridLines="None" Visible="False" >
                <Columns>
                    ...
                    <asp:BoundField DataField="CreateUser" HeaderText="Użytkownik" SortExpression="CreateUser" />
                </Columns>
            </asp:GridView>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT replace(replace(replace(replace(replace(replace(replace([ActiveStatus],'0','Zamknięte powodzeniem'),'1','Aktywne nie odpisano'),'2','Otwarte'),'3','Zablokowane'),'4','Anulowane helpdesk'),'5','Zamknięte niepowodzeniem'),'6','Anulowane użytkownicy') as Status ,Count('[ActiveStatus]') as [Ilość] ,CreateUser FROM [INZ_Ticket1] as a Left Join [INZ_Ticket2]  as b On a.ID = b.ID where DateMode between @DateCreate and @DateCreate2 Group by  [ActiveStatus] ,CreateUser ">
              <SelectParameters>
